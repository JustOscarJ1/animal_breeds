...
request_data = requests.get('https://en.wikipedia.org/wiki/List_of_birds_by_common_name').text # Makes a request to the website and gets the HTML data by accessing the .text attribute of the request.
